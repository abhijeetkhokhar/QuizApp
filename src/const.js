...
const QUESTIONS_BY_SUBJECT = {
  physics: [
    ...
    },
    {
      id: 4,
      question:
        "An object with mass 2 kg is moving with a velocity of 4 m/s. What is its momentum?",
  ...
  chemistry: [
    ...
    },
    {
      id: 3,
      question:
        "Which gas is produced when hydrochloric acid reacts with sodium hydroxide?",
...
export { SUBJECTS, QUESTIONS_BY_SUBJECT };